<template>
    <div class="container">
        ...
        <form @submit.prevent="submit">
            ...
            <label>Building Insurance Coverage</label>
            <input v-model="buildingInsuranceCoverage" type="text">
            <label>Insurance Deductible</label>
            <input v-model="insuranceDeductible" type="text">
            <label>Insurance Premium</label>
            <input v-model="insurancePremium" type="text">
        </form>
